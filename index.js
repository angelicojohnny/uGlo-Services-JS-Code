...
const slides = Array.from(document.querySelectorAll(".slide")).filter(slide =>

!slide.classList.contains("w-inline-block")
...
slide.style.transform = `rotate(${diff * 5}deg) translateY(${Math.abs(diff) * 50}px) translateX(${diff * 100}%)`;
